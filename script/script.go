...
func main() {
	...
	clusterID := os.Getenv("CLUSTER_ID")     // Замените на ваш CLUSTER_ID
	clientID := os.Getenv("CLIENT_ID")       // Замените на ваш PUBLISHER_ID
	channelName := os.Getenv("CHANNEL_NAME") // Замените на ваш CHANNEL_NAME
	...
	for {
		message := Message{Text: "Пример сообщения"} // Замените на свои данные
